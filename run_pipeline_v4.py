"""
ChrTracer3 V4_test full pipeline — drift + spot detection + fitting (2026-03-30).
...
DAX_DIR = Path("path/to/your/ChrTracer3")        # directory containing Readout_NNN/ folders
OUT_DIR = DAX_DIR / "analysis_output"
